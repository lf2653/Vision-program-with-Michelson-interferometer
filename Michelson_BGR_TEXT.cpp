...
{
	VideoCapture cam(0);//打开摄像头:0一般为内置摄像头，1为外置摄像头
	...
	cvCreateTrackbar("B下界", "Control", &iLowB, 255);
	cvCreateTrackbar("B上界", "Control", &iHighB, 255);
	cvCreateTrackbar("G下界", "Control", &iLowG, 255);
	cvCreateTrackbar("G上界", "Control", &iHighG, 255);
	cvCreateTrackbar("R下界", "Control", &iLowR, 255);
	cvCreateTrackbar("R上界", "Control", &iHighR, 255);
#endif
...
#ifdef BGR
		inRange(g_SrcImage, Scalar(iLowB, iLowG, iLowR), Scalar(iHighB, iHighG, iHighR), g_BinaryImage);
#endif
